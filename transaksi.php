                ...
                <div class="card-body">
                  <form method='post' action='aksi_transaksi.php?act=input'>
                    <div class="form-group">
                      <label for="nama">Pilih Nama Pembeli</label>
					  ...
					  <?php
						...
						$pembeli = $d["NAMA_PEMBELI"];
						echo "<option value='$id_pembeli'>$pembeli</option>";
						}
						?>
						</select>
                    ...
                    <div class="form-group">
					  ...
					  <?php												
						$stid = oci_parse($koneksi, 'SELECT * from BERAS');
						oci_execute($stid);
						while (($d = oci_fetch_array ($stid, OCI_BOTH)) != false) {
						$id_beras = $d["ID_BERAS"];
						$beras = $d["JENIS_BERAS"];
						echo "<option value='$id_beras'>$beras</option>";
						}
						?>
						</select>
