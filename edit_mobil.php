      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
		  ...
		  <div class="row">
			...
			$stid = oci_parse($koneksi, "SELECT * FROM mobil WHERE id_mobil='$id_beras'");
			oci_execute($stid);
                ...
                <div class="card-body">
                  <form method='post' action='aksi_mobil.php?act=update'>
					...
					<input type="hidden" name="id_mobil" value="<?php echo $d["ID_MOBIL"]; ?>">
                      <label for="nama">Plat Nmor</label>
                      <input type="text" class="form-control" name="nama" value="<?php echo $d["PLAT_NOMOR"]; ?>">
                      </div>
                    <div class="form-group">
